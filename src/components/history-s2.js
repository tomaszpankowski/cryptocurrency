...
class HistoryS2 extends Component{
    render(){
        return(    
            <Container fluid className="history-s2 d-flex minh-50vh align-items-center py-5 border-top border-dark pt-5">
