...
class HistoryS1 extends Component{
    render(){
        return(    
            <Container fluid className="history-s1 d-flex bg-secondary minh-50vh align-items-center py-5 border-top ">
